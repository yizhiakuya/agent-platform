...
class ChatAuthFilterTest {
    ...
    void clearsPrincipalContextWhenInternalTokenRejected() throws Exception {
        ChatAuthFilter filter = new ChatAuthFilter(jwt(), INTERNAL_TOKEN, List.of("/api/"));
        MockHttpServletRequest req = new MockHttpServletRequest("GET", "/internal/sessions");

...
/**
 * Shared downstream-service auth filter:
 * gateway-authenticated trusted headers first, direct Bearer JWT fallback second.
 */
public class HybridAuthFilter extends AbstractAuthFilter {

    private static final Logger log = LoggerFactory.getLogger(HybridAuthFilter.class);
    ...
    public HybridAuthFilter(JwtUtil jwt, String internalToken, List<String> protectedPrefixes) {
        this.jwt = jwt;

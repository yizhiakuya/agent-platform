...
This project is indexed by GitNexus as **agent-platform** (3131 symbols, 7378 relationships, 261 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.

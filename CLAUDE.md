...
This project is indexed by GitNexus as **agent-platform** (5922 symbols, 14680 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.

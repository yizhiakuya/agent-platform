...
This project is indexed by GitNexus as **agent-platform** (5869 symbols, 14354 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.

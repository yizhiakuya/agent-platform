...
This project is indexed by GitNexus as **agent-platform** (4830 symbols, 11665 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.

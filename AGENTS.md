...
This project is indexed by GitNexus as **agent-platform** (6545 symbols, 16424 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
